...
SAMPLE_DOCS = [
    # Employee id=4 (Margaret Harris, HR)
    ...
    # Employee id=12 (George Sanchez, IT) - used by test_employee user
    ...
    # Employee id=13 (Ryan Wilson, Product) - used by test_clean_employee user
    ...
    # Employee id=143 (James Morales, IT) - used by test_supervisor user
