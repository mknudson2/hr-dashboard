...
from .encrypted_types import EncryptedString, EncryptedText
...
class Interview(Base):
    ...
    calendar_event_id = Column(String, nullable=True)  # Provider's event ID for updates/cancellation
    calendar_provider = Column(String, nullable=True)  # "microsoft" or "google"
    meeting_link_auto = Column(Boolean, default=False)  # Video link was auto-generated by calendar provider
    ics_sent = Column(Boolean, default=False)  # .ics calendar file sent to candidate
...
class CalendarConnection(Base):
    """OAuth calendar connection for a user (Microsoft 365 or Google Workspace)."""
    ...
    calendar_email = Column(String, nullable=True)  # May differ from HR system email
    ...
    __table_args__ = (
        Index('ix_calendar_connection_user', 'user_id'),
    )
