      ...
      <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-300 dark:border-gray-600 p-2 flex flex-wrap gap-1 items-center">
        ...
        {showLinkInput ? (
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => { setShowLinkInput(false); setLinkUrl(''); }} className="px-2 py-1 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
              Cancel
            </button>
          </div>
        ) : (
