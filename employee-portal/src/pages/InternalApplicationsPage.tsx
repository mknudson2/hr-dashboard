    ...
    <div className="p-6">
      {viewMode === 'bifrost' ? (
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">My Internal Applications</h1>
          <p className="text-sm text-gray-600 mt-1">Track your internal transfer applications</p>
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white border border-gray-200 rounded-lg">
          <p className="text-gray-500">You haven't applied for any internal positions yet.</p>
          <Link
            to="/internal-jobs"
